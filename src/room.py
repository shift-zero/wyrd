...
NPC_TITLES = {
    "plaza": ["town crier", "street sweeper", "loiterer", "courier", "herald", "merchant", "traveler"],
    "street": ["peddler", "beggar", "messenger", "guard", "citizen", "child"],
    "house": ["homeowner", "servant", "child", "elder"],
    "shop": ["shopkeeper", "vendor", "haggler", "customer"],
    "tavern": ["innkeeper", "barmaid", "bard", "patron", "drunken farmer", "traveling merchant"],
    "inn": ["innkeeper", "host", "servant", "traveler"],
    "temple": ["priest", "acolyte", "pilgrim", "monk", "devotee", "novice"],
    "guildhall": ["guildmaster", "apprentice", "journeyman", "member"],
    "manor": ["steward", "servant", "guard", "noble"],
    "farm": ["farmer", "laborer", "child", "oxherd"],
    "docks": ["fisherman", "dockhand", "shipwright", "sailor", "harbormaster"],
    "gate": ["guard", "captain", "watchman", "sentry", "sergeant"],
