...
|| 2 🟡 | Textual-based TUI (or equivalent Python framework) | `wyrd` drops into a polished, navigable interface with tabs, help, status bar, modal overlays (sim-aware: `wyrd tui --seed 42` launches Textual viewer with sim controls, event log, live stats, year-diff) — 2026-07-23 |
